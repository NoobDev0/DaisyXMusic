...
@Client.on_message(filters.private & filters.incoming & filters.command(['vcplayerstart']))
...
@Client.on_message(filters.private & filters.incoming & filters.command(['vcplayerhelp']))
